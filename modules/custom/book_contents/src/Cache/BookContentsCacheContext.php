...
namespace Drupal\book_contents\Cache;
...
/**
 * Defines the book contents cache context service.
 *
 * Cache context ID: 'route.book_contents'.
 *
 * This allows for book contents location-aware caching. It depends on:
 ...
 */
class BookContentsCacheContext implements CacheContextInterface, ContainerAwareInterface {
  ...
  /**
   * Constructs a new BookContentsCacheContext service.
   *

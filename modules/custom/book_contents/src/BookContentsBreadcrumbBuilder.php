...
namespace Drupal\book_contents;
 ...
 */
class BookContentsBreadcrumbBuilder implements BreadcrumbBuilderInterface {
  ...
  /**
   * Constructs the BookContentsBreadcrumbBuilder.
   *
  ...
  public function build(RouteMatchInterface $route_match) {
    ...
    $breadcrumb->addCacheContexts(['route.book_contents']);
    return $breadcrumb;
  }
